...
console.log('Exercise 5 Result:', greetUser('Sam', 'orning'))
...
const convertTemperature = (tem, str) => {
  if (str === 'F') {
    return (5 / 9) * (tem - 32)
  } else if (str === 'C') {
    return tem * 1.8 + 32
...
const createUsername = (firstName, lastName) => {
  let len = (firstName + lastName).length
  return `${firstName.substring(0, 3) + lastName.substring(0, 3) + len} `
}
